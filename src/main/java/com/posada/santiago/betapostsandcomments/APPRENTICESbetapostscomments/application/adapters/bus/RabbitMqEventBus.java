...
import com.posada.santiago.betapostsandcomments.APPRENTICESbetapostscomments.application.handlers.QueryHandler;
...
//    }
    ...
    public void publishPostViewModel(PostViewModel postViewModel) {
        logger.info("Sending message from beta to gamma");
